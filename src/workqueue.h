 ...
 **/
workqueue_t *workqueue_new(void);
...
/**
 * Launch queued work on a number of threads without waiting for them to finish.
 **/
void workqueue_launch_nb(workqueue_t* wq, unsigned short nb_threads);
...
/**
 * Obtain the number of tasks still in the queue.
 **/
size_t workqueue_length(workqueue_t *wq);
